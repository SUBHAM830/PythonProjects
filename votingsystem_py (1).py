...
Original file is located at
    https://colab.research.google.com/drive/1mjkiuL5i_sGFEicRAN4xL_TsrGra2Onk
"""
...
while True:
    if voter_id ==[]: 
    #check when voter list is completed
        ...
        if(nm1_votes > nm2_votes):
              ...
              break
                ...
                print("Both have equal votes !!!! Govrnment will decide")
                break
    ...
    if voter in voter_id:
        ...
        if vote == 1:
            ...
            nm2_votes += 1
            print(nominee2,"Thanks you to give your import vote to them")
        elif vote >2:
